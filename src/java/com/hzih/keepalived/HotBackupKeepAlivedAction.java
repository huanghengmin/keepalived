...
import com.hzih.keepalived.utils.Dom4jUtil;
import com.hzih.keepalived.utils.KeepAlivedConfigUtil;
...
public class HotBackupKeepAlivedAction extends ActionSupport {
    ...
    public static final String keepalived_xml = "/etc/keepalived/keepalived.xml";
        ...
        try {
            ...
            if(doc!=null) {
                ...
                if(del_url!=null) {
                    ...
                    logger.info("用户查找双机热备配置信息成功"+new Date());
                }
            }
        } catch (Exception e) {
